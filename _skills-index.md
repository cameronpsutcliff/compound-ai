...
Base after the skill-merge: 26 active SKILL.md files + 4 retired redirect stubs
(30 SKILL.md files total). Team edition adds `team-router`; Individual derive omits `team/`.
