...
without the tiered router, that bundle costs about **35.5x** the
context this kit loads at session start. Loading the full doctrine reference is
an upper-bound ceiling at **156.2x**. This measures context-loading
...
|---|---:|---:|---:|
| Naive full reference (resident) | 151 | 840626 | 210156 |
| Realistic single-tier (no router) | 16 | 191254 | 47813 |
| Kit session-start (tier-0) | 2 | 5381 | 1345 |

## Ratios

- **Typical contribution, realistic / kit:** 35.5x
- **Upper-bound ceiling, naive / kit:** 156.2x
