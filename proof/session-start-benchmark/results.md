...
without the tiered router, that bundle costs about **35.8x** the
context this kit loads at session start. Loading the full doctrine reference is
an upper-bound ceiling at **158.6x**. This measures context-loading
...
|---|---:|---:|---:|
| Naive full reference (resident) | 151 | 837569 | 209392 |
| Realistic single-tier (no router) | 16 | 188995 | 47248 |
| Kit session-start (tier-0) | 2 | 5281 | 1320 |

## Ratios

- **Typical contribution, realistic / kit:** 35.8x
- **Upper-bound ceiling, naive / kit:** 158.6x
