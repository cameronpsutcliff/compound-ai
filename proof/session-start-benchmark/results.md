...
without the tiered router, that bundle costs about **35.7x** the
context this kit loads at session start. Loading the full doctrine reference is
an upper-bound ceiling at **156.4x**. This measures context-loading
...
|---|---:|---:|---:|
| Naive full reference (resident) | 151 | 841615 | 210403 |
| Realistic single-tier (no router) | 16 | 192243 | 48060 |
| Kit session-start (tier-0) | 2 | 5381 | 1345 |

## Ratios

- **Typical contribution, realistic / kit:** 35.7x
- **Upper-bound ceiling, naive / kit:** 156.4x
